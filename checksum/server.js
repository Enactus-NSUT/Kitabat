...
var PaytmConfig = {
	mid: "WcoGLr02207048403162",
	key: "NRCjypx2MnqH2DU6",
	website: "WEBSTAGING",
}
let txn = 0;
...
http.createServer(function (req, res) {
	switch(req.url){
		...
		case "/":
					...
					if (req.method === 'POST') {
						var txn = 0;
		        collectRequestData(res,req,result => {
		        	  return result.TXN_AMOUNT;
				        })
...
function collectRequestData(res,request,callback) {
