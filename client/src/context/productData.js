export const items = [
  ...
  },
  {
    ...
    fields: {
      ...
      company: "Kitabat",
      description:[
        "This exquisite artwork is made by one of our very own katibs, Mazahir Zaidi. The transcript is as follows : \n Trascript Bismillah-hir-Rahman-nir-raheem Qul huwa Allahu ahadun Allahu alssamadu  Lam yalid walam yooladu  Walam yakun lahu kufuwan ahadun Translation [Oh Pophet(pbuh) Say]: He, Allah, is One. Allah is He on Whom all depend. He begets not, nor is He begotten. And none is like Him.",
      ],
      featured: true,
